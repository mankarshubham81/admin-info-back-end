...
const connectn  = require('./config/db');
...
app.post("/create",(req, res) => {
  ...
  app.post("/editemployee", (req, res) => {
    ...
    // const sqlQuery = "INSERT INTO `datatable` (firstName, lastName, age, mobileNumber) VALUES (?,?,?,?)";
    const sqlQuery = "UPDATE datatable SET firstName = ?, lastName = ?, age = ?, mobileNumber = ? WHERE mobileNumber = ?";
    connection.query(sqlQuery, [firstName,lastName,age,mobileNumber, oldNumber], (err, results) => {
      if (err) {
        console.error('Error executing query:', err);
        return;
      }
